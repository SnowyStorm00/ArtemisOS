...
// Complete standard 8x8 ASCII Font (0-127)
uint8_t font8x8_basic[128][8] = {
    ...
    {0x3C, 0x66, 0xC0, 0xCE, 0x66, 0x66, 0x3E, 0x00}, // 71 G
    {0x66, 0x66, 0x66, 0xFE, 0x66, 0x66, 0x66, 0x00}, // 72 H
    ...
    {0xFC, 0x66, 0x66, 0xFC, 0xCC, 0x66, 0x66, 0x00}, // 82 R
    {0x3C, 0x66, 0xC0, 0x3C, 0x06, 0x66, 0x3C, 0x00}, // 83 S
    ...
    {0xC0, 0xC0, 0xFC, 0x66, 0x66, 0x66, 0xFC, 0x00}, // 98 b
    {0x00, 0x00, 0x3C, 0x66, 0xC0, 0x66, 0x3C, 0x00}, // 99 c
    {0x06, 0x06, 0x3E, 0x66, 0x66, 0x66, 0x3E, 0x00}, // 100 d
    {0x00, 0x00, 0x3C, 0x66, 0xFE, 0xC0, 0x3C, 0x00}, // 101 e
    {0x1C, 0x30, 0x30, 0xFC, 0x30, 0x30, 0x30, 0x00}, // 102 f
    {0x00, 0x00, 0x3E, 0x66, 0x66, 0x3E, 0x06, 0x3C}, // 103 g
    {0xC0, 0xC0, 0xFC, 0x66, 0x66, 0x66, 0x66, 0x00}, // 104 h
    {0x18, 0x00, 0x38, 0x18, 0x18, 0x18, 0x3C, 0x00}, // 105 i
    {0x06, 0x00, 0x06, 0x06, 0x06, 0x06, 0x06, 0x3C}, // 106 j
    {0xC0, 0xC0, 0xCC, 0xD8, 0xF0, 0xD8, 0xCC, 0x00}, // 107 k
    {0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00}, // 108 l
    {0x00, 0x00, 0xFC, 0xD6, 0xD6, 0xD6, 0xC6, 0x00}, // 109 m
    {0x00, 0x00, 0xFC, 0x66, 0x66, 0x66, 0x66, 0x00}, // 110 n
    {0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00}, // 111 o
    {0x00, 0x00, 0xFC, 0x66, 0x66, 0xFC, 0xC0, 0xC0}, // 112 p
    {0x00, 0x00, 0x3E, 0x66, 0x66, 0x3E, 0x06, 0x06}, // 113 q
    {0x00, 0x00, 0xDC, 0x66, 0x60, 0x60, 0x60, 0x00}, // 114 r
    {0x00, 0x00, 0x3E, 0xC0, 0x3C, 0x06, 0x7C, 0x00}, // 115 s
